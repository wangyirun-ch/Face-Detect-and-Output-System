...
def get_folder_size(folder):
    ...
    return size
def enterformat(put):
    print(put,"picture format? Input'jpg','jpeg','png','bmp',etc.")
    putpicformat=input('')
    while putpicformat!='jpg'and putpicformat!='JPG'and putpicformat!='jpeg' and putpicformat!='JPEG' and putpicformat!='png'and putpicformat!='PNG'and putpicformat!='bmp' and putpicformat!='BMP':
...
print("If you have already confirmed the settings, please enter 'start' to start processing.")
confirm=input('')
while confirm!='start':
    print("If you have already confirmed the content in the 'Input' folder, please enter 'start' to start processing.")
    confirm=input('')
...
if mode==1:
    ...
    if maxnum==0:
        ...
        if jpgnum!=0:
            print("JPEG format picture number:",jpgnum)
        if pngnum!=0:
